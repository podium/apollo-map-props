# Contributing to Apollo Map Props
...
making it easier for developers to [contribute to Apollo Map Props](#pull-requests).
...
your Operating System, as well as your Node and Apollo Map Props versions. Please provide steps to
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/apollo-map-props

   # Navigate to the newly cloned directory
   cd apollo-map-props

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/podium/apollo-map-props
   ```
...
- We use the `html` code fence for html templates, even if there is Javascript code
  in the template.
